...
//		return MemberOfStaffShortVoAssembler.create(mosBo);
	...
	public LocShortVoCollection listLocationsForMemberOfStaff(MemberOfStaffRefVo mos, Boolean excludeVirtualLoc)
	{
		...
		while (iter.hasNext())
		{
			...
			if (loc == null || (Boolean.TRUE.equals(excludeVirtualLoc) && loc.isIsVirtual())) //WDEV-19532  filter virtual locations
				continue;
	...
	public Boolean isCurrentMosMappedToUser(MemberOfStaffRefVo currentMos) //WDEV-22742
	{
