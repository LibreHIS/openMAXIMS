...
import ims.clinicaladmin.forms.cciadmin.GenForm.lyrDetailsLayer.tabNUMappingsContainer.grdNUmappingsRow;
...
public class Logic extends BaseLogic
{
	...
	public void initialize() //WDEV-17431
	{
		...
		//form.cmbProcDefaultAnaesthType().removeRow(AnaestheticType.LA_PRE_ASSESSMENT); //WDEV-20252,wdev-20561
		/*WDEV-11921 - Start
	...
	public void updateControlsState()
	{
		...
		if (form.rdoGrp().getValue().equals(rdoGrpEnumeration.rdoProcedures))
		{
			...
			//wdev-19500
			form.chkOutpatientOnly().setEnabled(viewMode ? Boolean.FALSE : Boolean.TRUE);
			
			//WDEV-20629
			form.chkMedicalWL().setEnabled(viewMode ? Boolean.FALSE : Boolean.TRUE);
			
			//WDEV-20252
			form.cmbProcDefaultAnaesthType().setEnabled(viewMode ? Boolean.FALSE : Boolean.TRUE);
			form.cmbProcGenderSpecific().setEnabled(viewMode ? Boolean.FALSE : Boolean.TRUE);
			form.chkProcBilateralListing().setEnabled(viewMode ? Boolean.FALSE : Boolean.TRUE);
			form.chkEndoscopy().setEnabled(viewMode ? Boolean.FALSE : Boolean.TRUE);
			form.cmbEndoscopyType().setEnabled(viewMode ? Boolean.FALSE : form.chkEndoscopy().getValue());
			form.chkProcLaterality().setEnabled(viewMode ? Boolean.FALSE : Boolean.TRUE);
			//WDEV-20252 --- ends here
			form.chkEndoscopy().setEnabled(viewMode ? Boolean.FALSE : Boolean.TRUE);
			form.lyrDetails().tabMappings().setHeaderVisible(false); //http://jira/browse/WDEV-20066
			form.lyrDetails().tabNUMappings().setHeaderVisible(true);
		}
		else
		{
			form.lyrDetails().tabNUMappings().setHeaderVisible(false);
			form.lyrDetails().tabMappings().setHeaderVisible(true);
		}//http://jira/browse/WDEV-20066
		...
		else
		{
			...
			{
				form.getContextMenus().Admin.getTaxonomyGridUpdateTaxonomyItem().setVisible(form.lyrDetails().tabNUMappings().grdNUmappings().getSelectedRowIndex()>=0);//WDEV-11921
				form.getContextMenus().Admin.getTaxonomyGridRemoveTaxonomyItem().setVisible(form.lyrDetails().tabNUMappings().grdNUmappings().getSelectedRowIndex()>=0);//WDEV-11921
			}
			else
			{
	...
	private void setCciNames(rdoGrpEnumeration rdoOption)
	{
		...
		//wdev-19500
		form.chkOutpatientOnly().setVisible(Boolean.FALSE);
		
		//WDEV-20629
		form.chkMedicalWL().setVisible(Boolean.FALSE);
		form.lblMedicalWL().setVisible(Boolean.FALSE);
		
		//WDEV-20252
		form.cmbProcDefaultAnaesthType().setVisible(Boolean.FALSE);
		form.cmbProcGenderSpecific().setVisible(Boolean.FALSE);
		form.chkProcBilateralListing().setVisible(Boolean.FALSE);
		form.cmbEndoscopyType().setVisible(Boolean.FALSE);
		form.chkProcLaterality().setVisible(Boolean.FALSE);
		form.lblProcBilateralListing().setVisible(Boolean.FALSE);
		form.lblOutpatientOnly().setVisible(Boolean.FALSE);
		form.lblProcDefaultAnaesth().setVisible(Boolean.FALSE);
		form.lblProcGenderSpecific().setVisible(Boolean.FALSE);
		form.lblEndoscopyType().setVisible(Boolean.FALSE);
		form.lblProcLaterality().setVisible(Boolean.FALSE);
		form.lblEndoscopy().setVisible(false); //WDEV-20158
		form.chkEndoscopy().setVisible(false); //WDEV-20158
		
		//WDEV-20252 -- end
		
		if(rdoOption == rdoGrpEnumeration.rdoProcedures)
		{
			form.lblAlgType().setValue("Duration in Minutes:");	
			...
			//wdev-19500
			form.chkOutpatientOnly().setVisible(Boolean.TRUE);
			
			//WDEV-20629
			form.chkMedicalWL().setVisible(Boolean.TRUE);
			form.lblMedicalWL().setVisible(Boolean.TRUE);
			
			//WDEV-20252
			form.cmbProcDefaultAnaesthType().setVisible(Boolean.TRUE);
			form.cmbProcGenderSpecific().setVisible(Boolean.TRUE);
			form.chkProcBilateralListing().setVisible(Boolean.TRUE);
			form.cmbEndoscopyType().setVisible(Boolean.TRUE);
			form.chkProcLaterality().setVisible(Boolean.TRUE);
			form.lblProcBilateralListing().setVisible(Boolean.TRUE);
			form.lblOutpatientOnly().setVisible(Boolean.TRUE);
			form.lblProcDefaultAnaesth().setVisible(Boolean.TRUE);
			form.lblProcGenderSpecific().setVisible(Boolean.TRUE);
			form.lblEndoscopyType().setVisible(Boolean.TRUE);
			form.lblProcLaterality().setVisible(Boolean.TRUE);
			//WDEV-20252  -- ends here
			form.lblEndoscopy().setVisible(true); //WDEV-20158
			form.chkEndoscopy().setVisible(true); //WDEV-20158
		}
	...
	public void clearInstanceControls()
	{
		...
		form.lyrDetails().tabNUMappings().grdNUmappings().getRows().clear();//http://jira/browse/WDEV-20066
		...
		form.chkOutpatientOnly().setValue(null);	//wdev-19500
		//form.getLocalContext().setSelectedItem(null);
		
		//WDEV-20629
		form.chkMedicalWL().setValue(null);
		...
		//WDEV-20252
		form.cmbProcDefaultAnaesthType().setValue(null);
		form.cmbProcGenderSpecific().setValue(null);
		form.chkProcBilateralListing().setValue(false);
		form.cmbEndoscopyType().setValue(null);
		form.chkProcLaterality().setValue(false);
		form.chkEndoscopy().setValue(false);
	...
	private void populateInstanceControls(ICciFull cci)
	{
		...
		form.chkOutpatientOnly().setValue(cci.getCciProcedureOutPatientOnly());	//wdev-19500
		
		//WDEV-20629
		form.chkMedicalWL().setValue(Boolean.TRUE.equals(cci.getCciProcedureMedicalWL()));
		...
		//WDEV-20252
		form.cmbProcDefaultAnaesthType().setValue(cci.getCciProcedureDefaultAnaestheticType());
		form.cmbProcGenderSpecific().setValue(cci.getCciProcedureGenderSpecific());
		form.chkProcBilateralListing().setValue(cci.getCciProcedureBilateralListingApplicable() != null ? cci.getCciProcedureBilateralListingApplicable().booleanValue() : false);
		form.chkProcLaterality().setValue(cci.getCciProcedureIsLateralityApplicable() != null ? cci.getCciProcedureIsLateralityApplicable().booleanValue() : false);
		//WDEV-20252 --- ends here
		
		if(cci instanceof ProcedureVo)
		{
			ProcedureVo pro = (ProcedureVo)cci;
			form.chkEndoscopy().setValue(pro.getIsEndoscopy() != null ? pro.getIsEndoscopy().booleanValue() : false);
			populateNUTaxonomyMappings(cci.getCciMappings());
		}
		else
		{
		...
		form.cmbEndoscopyType().setValue(cci.getCciProcedureEndoscopyType()); //WDEV-20252
	 ...
	 * @return void
	 */
	private void populateTaxonomyMappings(ims.vo.interfaces.ITaxonomyMapCollection coll)
	{
		...
		if (coll != null)
		{
			...
			for (int i=0; i < coll.size(); i++)
			{
				...
				row.setcolExtCodeType(coll.getITaxonomyMap(i).getTaxonomyName());					
				row.setcolCode(coll.getITaxonomyMap(i).getTaxonomyCode());
				TaxonomyMap tm = new TaxonomyMap();
				tm.setTaxonomyCode(coll.getITaxonomyMap(i).getTaxonomyCode());
				tm.setTaxonomyName(coll.getITaxonomyMap(i).getTaxonomyName());
				row.setValue(tm);
			}
		}
	}
	...
	{	
		...
		{
			form.txtSearch().setValue(form.getLocalContext().getSelectedItem().getIGenericItemInfoName());
			engine.showMessage("Record saved. Please review associated keywords.");
			open();
		}
	...
	public boolean save() throws PresentationLogicException
	{
		...
		if(cci instanceof ProcedureVo)
		{
			ProcedureVo proc = (ProcedureVo)cci;
			if(proc!=null&&proc.getTaxonomyMapIsNotNull())
			{
				for (NonUniqueTaxonomyMapVo tax : proc.getTaxonomyMap())
				{
					if(tax.getEffectiveFromIsNotNull()&&
						tax.getEffectiveToIsNotNull()&&
						tax.getEffectiveFrom().isGreaterThan(tax.getEffectiveTo()))
						{
							engine.showMessage("Effective From date should not be after Effective To date");
							return false;
						}
				}
			}
	...
	private ITaxonomyMapCollection getMappings(boolean isProcedure)
	{
		...
		{
			NonUniqueTaxonomyMapVoCollection coll =  new NonUniqueTaxonomyMapVoCollection();
			for (int i = 0; i < form.lyrDetails().tabNUMappings().grdNUmappings().getRows().size(); i++)//WDEV-11921
			{
				grdNUmappingsRow row = form.lyrDetails().tabNUMappings().grdNUmappings().getRows().get(i);//WDEV-11921
				NonUniqueTaxonomyMapVo voTaxonomyMap = row.getValue() != null?row.getValue():new NonUniqueTaxonomyMapVo();
				voTaxonomyMap.setTaxonomyCode(row.getcolCode());			
				voTaxonomyMap.setTaxonomyName(row.getcolExtCodeType());
				voTaxonomyMap.setEffectiveFrom(row.getcolEffectiveFrom());
				voTaxonomyMap.setEffectiveTo(row.getcolEffectiveTo());
				coll.add(voTaxonomyMap);
			}
			voTaxonomyMapCollection=coll;
		}
	...
	{
		if (form.rdoGrp().getValue().equals(rdoGrpEnumeration.rdoProcedures))//http://jira/browse/WDEV-20066 10102014
		{
			if (form.lyrDetails().tabNUMappings().grdNUmappings().getSelectedRow() != null)//WDEV-11921
				taxonomySearch(form.lyrDetails().tabNUMappings().grdNUmappings().getSelectedRow().getcolExtCodeType(),form.lyrDetails().tabNUMappings().grdNUmappings().getSelectedRow().getcolCode());//WDEV-11921
		}
		else
		{
	...
	private void removeTaxonomy() 
	{
		if (form.rdoGrp().getValue().equals(rdoGrpEnumeration.rdoProcedures))//http://jira/browse/WDEV-20066 10102014
		{
			form.lyrDetails().tabNUMappings().grdNUmappings().removeSelectedRow();
		}
		else
		{
	...
	protected void onFormDialogClosed(ims.framework.FormName formName, ims.framework.enumerations.DialogResult result) throws ims.framework.exceptions.PresentationLogicException
	{
		if ( (formName.equals(form.getForms().Core.TaxonomySearch)) && (result.equals(DialogResult.OK)) )
		{
			if(form.getGlobalContext().Core.getTaxonomyMapIsNotNull())
			{
				...
				if (form.rdoGrp().getValue().equals(rdoGrpEnumeration.rdoProcedures))
				{
					grdNUmappingsRow row=form.lyrDetails().tabNUMappings().grdNUmappings().getSelectedRow();
					if(row != null && voTaxonomyMap != null)
					{
						...
						if(row.getValue()==null)
							row.setValue(new NonUniqueTaxonomyMapVo());
						row.getValue().setTaxonomyName(voTaxonomyMap.getTaxonomyName());
						row.getValue().setTaxonomyCode(voTaxonomyMap.getTaxonomyCode());
...
//	@Override
	protected void onNUGrdExtCodesGridButtonClicked(int column,grdNUmappingsRow row) throws PresentationLogicException
	{
		if(form.getMode().equals(FormMode.EDIT))
			taxonomySearch(row.getcolExtCodeType(),row.getcolCode());
	}
	 ...
	 * @return void
	 */
	private void taxonomySearch(TaxonomyType type,String value)
	{
		if(type == null)
		{
			engine.showMessage("Please select Code Type");
			return;
		}
		...
		voTaxonomyMap.setTaxonomyName(type);
		voTaxonomyMap.setTaxonomyCode(value);
	...
	@Override
	protected void onChkEndoscopyValueChanged()	throws PresentationLogicException
	{
		form.cmbEndoscopyType().setEnabled(FormMode.EDIT.equals(form.getMode()) && form.cmbEndoscopyType().getVisible() && form.chkEndoscopy().getValue());
		if (!Boolean.TRUE.equals(form.chkEndoscopy().getValue()))
				form.cmbEndoscopyType().setValue(null);
		
	}

////	@Override
	protected void onNUGrdExtCodesSelectionChanged() throws PresentationLogicException //WDEV-20066 10102014
	{
		updateControlsState();
	}

	//wdev-21370
	protected void onChkProcBilateralListingValueChanged() throws PresentationLogicException
	{
		
		if( Boolean.TRUE.equals(form.chkProcBilateralListing().getValue()))
		{
			form.chkProcLaterality().setValue(true);
		}
		
	}

	//wdev-21370
	protected void onChkProcLateralityValueChanged() throws PresentationLogicException
	{
		if( !Boolean.TRUE.equals(form.chkProcLaterality().getValue()) )
		{
			form.chkProcBilateralListing().setValue(false);
		}
