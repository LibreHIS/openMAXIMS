...
public class PharmacyApprovalWorklistImpl extends BasePharmacyApprovalWorklistImpl
{
	...
	public ims.core.vo.LocationLiteVoCollection listWards(String wardName)
	{
		...
		String query = " FROM Location AS loc WHERE loc.upperName LIKE :NAME AND loc.isActive = TRUE AND loc.isVirtual = FALSE AND loc.type.id = " + LocationType.WARD.getID() + " order by loc.name asc";
