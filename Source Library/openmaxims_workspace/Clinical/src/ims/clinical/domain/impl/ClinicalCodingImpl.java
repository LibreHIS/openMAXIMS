...
import ims.core.domain.impl.TaxonomySearchImpl;
...
public class ClinicalCodingImpl extends BaseClinicalCodingImpl
{
	...
	* listHotlistProcedureShort
	 * @throws DomainInterfaceException 
	*/
	public ims.core.vo.ProcedureLiteVoCollection listHotlistProcedureShort(String procedureName, ims.core.vo.lookups.Specialty lkpSpecialty, Boolean outpatonly) throws DomainInterfaceException
	{
	...
	*/
	...
	{
			return 	listMedications(filterMedication, null);	////WDEV-20283
	}
...
//			check which constraint was violated (name/taxononmy map)
	...
	{
		return listDivisionDiagnoses(name, division, true); //WDEV-22287
	}
	...
	{
		TaxonomySearch impl = (TaxonomySearch) getDomainImpl(TaxonomySearchImpl.class);
		return impl.searchCodes(filter);
	}

	//wdev-19500
	public ProcedureLiteVoCollection listProcLiteVo(String filter) throws DomainInterfaceException
	{
		return listProcLiteVo(filter,null);
	}
	//wdev-19500
	public ProcedureLiteVoCollection listHotlistProcedureShort(String procedureName, Specialty lkpSpecialty) throws DomainInterfaceException
	{
		return listHotlistProcedureShort(procedureName,lkpSpecialty,null);
	}
	//wdev-20561 - used by Waiting List Card - RefMan.ElectiveListAddLaterDialog
	public ProcedureVoCollection listProcedureVo(String name, Boolean isMedication, Boolean isEndoscopy, Boolean outpatientOnly, Specialty specialty, Boolean allProceduresORHotlist) throws DomainInterfaceException
	{
		DomainFactory factory = getDomainFactory();
		
		//if( isEndoscopy != null &&  Boolean.TRUE.equals(isEndoscopy))
		if( Boolean.TRUE.equals(allProceduresORHotlist))	//wdev-21151
		{
			StringBuffer hql = new StringBuffer(" from Procedure proc join proc.keywords as kw ");
			ArrayList names = new ArrayList();
			ArrayList values = new ArrayList();
		...
		else
		{
    		...
    		return ProcedureVoAssembler.createProcedureVoCollectionFromProcedure(ret);
