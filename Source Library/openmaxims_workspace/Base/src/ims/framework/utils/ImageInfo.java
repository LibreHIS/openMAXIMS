...
public class ImageInfo {
	...
	private static final byte[] IFF_RM = {0x52, 0x4d};
	private static final byte[] APP0_ID = {0x4a, 0x46, 0x49, 0x46, 0x00};
	private static final byte[] PNG_MAGIC = {0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a};
	private static final int[] PNM_FORMATS = {FORMAT_PBM, FORMAT_PGM, FORMAT_PPM};
	private static final byte[] PSD_MAGIC = {0x50, 0x53};
	private static final byte[] RAS_MAGIC = {0x6a, (byte)0x95};
	...
	public boolean check() {
		...
		if (in == null && din == null) return false;
