...
import ims.scheduling.vo.TheatreDetailVo;
...
public class Logic extends BaseLogic
{
	...
	private void loadTheatreSlots()
	{
		...
		for(SessionTheatreVo voSession : voCollSelectedSessions)
		{
			...
			//theatreDetails (from Sch_Profile) was not added to SessionTheatreVo as this vo is used in multiple places 
			//we should have just one session selected 
			TheatreDetailVoCollection theatreDetails = domain.getTheatreDetailsForSession(voSession);
			...
			if(theatreDetails != null)
			{
				...
				for(TheatreDetailVo voTheatreProcedure : theatreDetails)
				{
	...
	private boolean isProcedureSelectedInSearch(TheatreDetailVo voTheatreProcedure)
	{
	...
	protected void onFormDialogClosed(FormName formName, DialogResult result) throws PresentationLogicException
	{
		...
		form.getGlobalContext().Scheduling.setAppointmentIds(null);//wdev-19894
