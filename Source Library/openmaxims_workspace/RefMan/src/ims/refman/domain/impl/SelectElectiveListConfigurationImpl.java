...
public class SelectElectiveListConfigurationImpl extends BaseSelectElectiveListConfigurationImpl
{
	...
	public ElectiveListConfigurationLiteVoCollection listOtherElectiveListConfiguration(ServiceRefVo serviceRef, Specialty specialty, String listIdHcp, String electiveListName, Boolean bActive) //WDEV-18396
	{
		ArrayList<String> markers = new ArrayList<String>();
		ArrayList<Object> values = new ArrayList<Object>();
		...
		if (bActive !=null)
		{
			...
			hqlConditions.append(" eL.isActive = :bActive ");
			markers.add("bActive");
			if (bActive)
