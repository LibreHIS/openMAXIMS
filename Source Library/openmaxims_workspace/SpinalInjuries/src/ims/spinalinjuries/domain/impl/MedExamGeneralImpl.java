...
import ims.clinical.vo.ExamGenRefVo;
...
public class MedExamGeneralImpl extends DomainImpl implements ims.spinalinjuries.domain.MedExamGeneral, ims.domain.impl.Transactional
{
	...
	*/
	...
	{
		if (admisExamGeneralVo == null)
			throw new DomainRuntimeException("Exam General object is null");  //WDEV-19405 
		if (!admisExamGeneralVo.isValidated())
			throw new DomainRuntimeException("Exam General has not been validated");
		
		DomainFactory factory = getDomainFactory();
		ClinicalContact doClinicalContact = null; //WDEV-19405 
		
		if (contactVo != null)//WDEV-19405 NPE avoided
		{	
			doClinicalContact = (ClinicalContact)factory.getDomainObject(ClinicalContact.class, contactVo.getID_ClinicalContact());
		}
		...
		if(admisExamGeneralVo.getGenExaminationDetIsNotNull())
		{
			...
			//WDEV-19405
			if (doExamGen.getClinicalContact() == null && doClinicalContact != null)
	...
	public AdmisExamGeneralVo getAdmisExamGeneralByCareContext(CareContextRefVo voCareContextRef)
	{
		...
		if(voCareContextRef != null)
		{
			condStr.append(andStr + " examGen.careContext.id = :id_CareContext"); //WDEV-19405 
			markers.add("id_CareContext");
			values.add(voCareContextRef.getID_CareContext());
			andStr = " and ";
		}	
