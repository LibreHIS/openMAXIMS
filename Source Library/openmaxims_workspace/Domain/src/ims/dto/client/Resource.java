...
public final class Resource
{
	 ...
	 */ 
	public Resource(ims.dto.Connection connection) throws ims.dto.Exception
	{	
		if(connection == null)
	 ...
	 */
	public Resource cloneObject() throws ims.dto.Exception
	{
	...
	*/
	...
	private String encodeNASFilter(ResourceFilter filter)
	{
		...
		if(Filter.Ext != null && filter.Ext.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "EXT" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Ext;
		}
		...
		if(Filter.Tel2 != null && filter.Tel2.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "TEL2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Tel2;
		}
		...
		if(Filter.Ext2 != null && filter.Ext2.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "EXT2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Ext2;
		}
		...
		if(Filter.Bleep != null && filter.Bleep.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BLEEP" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bleep;
		}
		...
		if(Filter.Icws_insert != null && filter.Icws_insert.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "ICWS_INSERT" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Icws_insert;
		}
		...
		if(Filter.Rsflocation != null && filter.Rsflocation.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "RSFLOCATION" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Rsflocation;
		}
		...
		if(Filter.Rsflocationtxt != null && filter.Rsflocationtxt.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "RSFLOCATIONTXT" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Rsflocationtxt;
		}
	...
	private String encodeNASMessage()
	{
		...
		ResourceRecord data = DataCollection.get(0);
		...
		if(EditFilter.IncludeExt)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "EXT" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Ext);
		}
		...
		if(EditFilter.IncludeTel2)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "TEL2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Tel2);
		}
		...
		if(EditFilter.IncludeExt2)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "EXT2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Ext2);
		}
		...
		if(EditFilter.IncludeBleep)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BLEEP" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bleep);
		}
		...
		if(EditFilter.IncludeIcws_insert)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "ICWS_INSERT" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Icws_insert);
		}
		...
		if(EditFilter.IncludeRsflocation)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "RSFLOCATION" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Rsflocation);
		}
		...
		if(EditFilter.IncludeRsflocationtxt)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "RSFLOCATIONTXT" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Rsflocationtxt);
		}
