...
public class MOSQueryImpl extends BaseMOSQueryImpl
{
	...
	public IMos[] listMOS(String name, MosType mosType, HcpDisType mosDiscipline, Integer mosLocation, Boolean canReferPatient, Boolean isALocalConsultant, Boolean isResponsibleHcp, ServiceRefVo service, ServiceFunction function) 
	{
		...
		{
			return listHCP(name, null, mosDiscipline, mosLocation, canReferPatient,isALocalConsultant,isResponsibleHcp, service, function);//WDEV-15544 //WDEV-15194
		}
		if(mosType.equals(MosType.MEDIC))
		{
			return listHCP(name, MEDIC, null, mosLocation, canReferPatient,isALocalConsultant,isResponsibleHcp, service, function);//WDEV-15544 //WDEV-15194
		}
	...
	//WDEV-15544 //WDEV-15194
	private IMos[] listHCP(String name, String subClass, HcpDisType mosDiscipline, Integer mosLocation, Boolean canReferPatient,Boolean isALocalConsultant,Boolean isResponsibleHcp, ServiceRefVo service, ServiceFunction function) 
	{
		List hcps = listHCPList(name, subClass, mosDiscipline, mosLocation, canReferPatient,isALocalConsultant,isResponsibleHcp, service, function);//WDEV-15544	//WDEV-15194
	...
	//WDEV-15544  //WDEV-15194 
	private List listHCPList(String name, String subClass, HcpDisType mosDiscipline, Integer mosLocation, Boolean canReferPatient,Boolean isALocalConsultant,Boolean isResponsibleHcp, ServiceRefVo service, ServiceFunction function) 
	{
		if(name == null || (name != null && name.length() == 0))
			throw new DomainRuntimeException("Can not search on null name.");
		...
		if(service != null)
		{
			hql += " left join h.serviceFunction as servf left join servf.service as serv ";
		}
		...
		if(service != null)
		{
			...
			if(function != null)
			{
				condStr.append(" and servf.function.id  = :FunctionId ");
				markers.add("FunctionId");
				values.add(function.getID());
			}
		}
